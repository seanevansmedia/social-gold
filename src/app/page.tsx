    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-6 py-12 text-center">
      <div className="max-w-3xl w-full animate-in fade-in zoom-in duration-1000">
        ...
        {user ? (
          <div className="mt-12 space-y-8 flex flex-col items-center">
            ...
            <div className="flex flex-col items-center gap-4 w-full">
              <Link
                ...
                className="w-full md:w-72 rounded-2xl py-5 text-sm font-black text-primary-foreground shadow-[0_20px_50px_rgba(202,138,4,0.3)] transition-all hover:scale-105 active:scale-95 uppercase tracking-[0.2em] flex justify-center items-center"
              >
                Go to Feed
              </Link>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 px-4 w-full mt-12">
            {/* SIGN IN BUTTON */}
            <Link
              href="/login"
              style={{ background: "linear-gradient(to right, var(--gradient-from), var(--gradient-to))" }}
              className="w-full md:w-64 rounded-2xl py-5 text-sm font-black text-primary-foreground shadow-2xl text-center uppercase tracking-[0.2em] hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              Sign In
            </Link>
            ...
            <Link
              href="/signup"
              className="w-full md:w-64 rounded-2xl border-2 border-primary py-5 text-sm font-black text-primary text-center hover:bg-primary/10 hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-[0.2em]"
            >
              Join Now
            </Link>
          </div>
